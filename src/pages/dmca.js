...
function renderStep3() {
  return `
    ...
    <div class="dmca-preview" id="dmca-notice-text">
      ...
      <br/>
      <p>Dear Platform Administrator,</p>
      <br/>
      <p>I am writing to report unauthorized use of copyrighted material hosted on your platform. The content described below is owned by our organization and is being distributed without authorization.</p>
      <br/>
      <p><strong>Original Work:</strong> IPL Official Logo — Registered Digital Asset #247</p>
      <p><strong>Infringing URL:</strong> https://suspicious-bets.com/promotions/ipl-live</p>
      <p><strong>Similarity Score:</strong> 94% (Content DNA verified)</p>
      <br/>
      <p>I have a good faith belief that the use of the material described above is not authorized by the copyright owner, its agent, or the law. I swear, under penalty of perjury, that the information in this notification is accurate.</p>
      <br/>
      <p>Please act expeditiously to remove or disable access to the infringing material.</p>
      <br/>
      <p>Sincerely,<br/>Digital Rights Management Team<br/>MediaShield AI Platform</p>
    </div>
  `;
}
...
function goToStep(step) {
  ...
  if (currentStep === 4) {
    document.getElementById('dmca-copy-btn')?.addEventListener('click', () => {
      const text = document.getElementById('dmca-notice-text')?.textContent || 'DMCA Notice content';
